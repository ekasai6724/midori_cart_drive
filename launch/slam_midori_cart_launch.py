...
def generate_launch_description():
    ...
    lidar_pkg_dir = launch.substitutions.LaunchConfiguration('lidar_pkg_dir',
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.IncludeLaunchDescription(
            launch.launch_description_sources.PythonLaunchDescriptionSource([lidar_pkg_dir, '/ld08.launch.py']),
